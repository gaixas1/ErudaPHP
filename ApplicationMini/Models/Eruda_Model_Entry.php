...
class Eruda_Model_Entry extends Eruda_Model implements Eruda_Interface_rssItem, Eruda_Interface_sitemapItem {
    ...
    */
    ...
    public function rss_get_comments() {
        return Eruda_Environment::getBaseURL().$this->id.'/'.Eruda_Helper_Parser::Text2Link($this->title).'/#comentar';
    }
    ...
    public function rss_get_link() {
        return Eruda_Environment::getBaseURL().$this->id.'/'.Eruda_Helper_Parser::Text2Link($this->title).'/';
    }
