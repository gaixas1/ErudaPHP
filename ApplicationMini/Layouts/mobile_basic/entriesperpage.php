                ...
                <article class="entrada" id="entrada_<?php echo $entry->get_id(); ?>">
                    ...
                    <footer class="entrada_pie">
                        <div class="entrada_social">
                            <a class="fb_link" target="_blank" href="<?php echo Eruda_Helper_Parser::facebookLink(Eruda_Environment::getBaseURL().$entry->get_id().'/'.Eruda_Helper_Parser::Text2Link($entry->get_title()).'/',$entry->get_title());?>">Compartir en FB</a>
                            <a class="twitter_link" target="_blank"  href="<?php echo Eruda_Helper_Parser::twitterLink(Eruda_Environment::getBaseURL().$entry->get_id().'/'.Eruda_Helper_Parser::Text2Link($entry->get_title()).'/',$entry->get_title());?>">Enviar a Twitter</a>
                            <a class="google_link" target="_blank"  href="<?php echo Eruda_Helper_Parser::googleLink(Eruda_Environment::getBaseURL().$entry->get_id().'/'.Eruda_Helper_Parser::Text2Link($entry->get_title()).'/',$entry->get_title());?>">Compartir en Google+</a>
                        </div>
